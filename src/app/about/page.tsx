...
export default function AboutPage() {
  return (
    <div className="pt-16">
      {/* Hero Section */}
      <section aria-labelledby="about-heading" className="py-20 gradient-bg text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 id="story-heading" className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 focus:outline-2 focus:outline-offset-2 focus:outline-primary-600 rounded-lg" tabIndex={0}>
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="bg-gradient-to-br from-primary-500 to-secondary-500 rounded-2xl p-8 text-white focus:outline-2 focus:outline-offset-2 focus:outline-white" tabIndex={0} role="region" aria-label="Company Highlights">
      ...
      {/* Timeline */}
      <section aria-labelledby="journey-heading" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 id="journey-heading" className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 focus:outline-2 focus:outline-offset-2 focus:outline-primary-600 rounded-lg" tabIndex={0}>
          ...
          <div className="relative">
            {/* Timeline line */}
            <div className="absolute left-1/2 transform -translate-x-1/2 w-1 h-full bg-primary-200" aria-hidden="true"></div>
              ...
              {milestones.map((milestone, index) => (
                ...
                >
                  <div className={`w-1/2 ${index % 2 === 0 ? 'pr-8 text-right' : 'pl-8 text-left'}`}>
                    <div className="card p-6 focus:outline-2 focus:outline-offset-2 focus:outline-primary-600" tabIndex={0} role="article" aria-label={`${milestone.year}: ${milestone.title}`}>
                  ...
                  {/* Timeline dot */}
                  <div className="w-4 h-4 bg-primary-600 rounded-full border-4 border-white shadow-lg z-10" aria-hidden="true"></div>
